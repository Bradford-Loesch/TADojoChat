app.controller("MessageController", ["$scope", "$routeParams", "$window", "SocketFactory", "MessageFactory", "UserFactory", "themer", function ($scope, $routeParams, $window, SocketFactory, MessageFactory, UserFactory, themer) {
  $scope.styles = styles
  $scope.allMessages = [];
  $scope.message = {};
  $scope.allUsers = [];
